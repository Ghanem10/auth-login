...
# Code walkthrough
  - after setting up your mongoose schema you can start by hashing your password with bcryptjs library.
      `pre(fc)` is a middleware for hashing before submitting to the DB, and `genSalt(num)` is the number of iteration
      for the algorithm [see this](https://github.com/dcodeIO/bcrypt.js#readme)
